...
// https://stackoverflow.com/questions/11088231/check-the-quality-of-wifi-connectivity
class Connectivity {
    /*
    ...
    public static boolean isConnected(){
        ConnectivityManager cm = (ConnectivityManager) MyMessenger.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
